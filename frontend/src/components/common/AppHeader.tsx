...
export function AppHeader({ userName, onLogout, loading = false }: AppHeaderProps) {
  return (
    <header className="mb-6 flex flex-col gap-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:flex-row md:items-start md:justify-between">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-slate-900 md:text-[30px]">AI Sales Page Generator</h1>
        <p className="mt-2 text-sm text-slate-600 md:text-base">Welcome, {userName}. Build, regenerate, and export.</p>
